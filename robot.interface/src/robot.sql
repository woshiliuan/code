...
CREATE TABLE `command` (
  ...
  `name` varchar(50) DEFAULT NULL COMMENT '命令名称',
...
INSERT INTO `command` VALUES ('3', '新闻', '娱乐新闻');
...
CREATE TABLE `command_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `content` varchar(50) DEFAULT NULL COMMENT '命令名称',
  `command_id` int(11) NOT NULL COMMENT '外键',
  PRIMARY KEY (`id`),
  KEY `fk_id` (`command_id`),
  CONSTRAINT `fk_id` FOREIGN KEY (`command_id`) REFERENCES `command` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of command_content
-- ----------------------------
INSERT INTO `command_content` VALUES ('1', '段子内容1', '2');
INSERT INTO `command_content` VALUES ('2', '段子内容2', '2');
INSERT INTO `command_content` VALUES ('3', '段子内容3', '2');
